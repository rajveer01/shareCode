"""Vault account system that emulate Vault account and operations betweem them."""
...
class TransactionType(StrEnum):
    """Represents several operation types in or between Vault accounts."""
...
class VaultAccount:
    """Represents a Vault account entity."""
    ...
    def transfer(self, other: VaultAccount, amount: int) -> None:
...
def main() -> None:
    account1 = VaultAccount(initial_balance=100)
    account2 = VaultAccount(initial_balance=50)
